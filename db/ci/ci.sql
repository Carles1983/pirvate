...
/*Table structure for table `ci_contact_201706` */

DROP TABLE IF EXISTS `ci_contact_201706`;

CREATE TABLE `ci_contact_201706` (
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_CONTACT_ID` varchar(50) DEFAULT NULL COMMENT '源系统接触流水号',
  `CONTACT_TIME` datetime NOT NULL COMMENT '接触时间',
...
/*Table structure for table `ci_contact_201803` */

DROP TABLE IF EXISTS `ci_contact_201803`;

CREATE TABLE `ci_contact_201803` (
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_CONTACT_ID` varchar(50) DEFAULT NULL COMMENT '源系统接触流水号',
  `CONTACT_TIME` datetime NOT NULL COMMENT '接触时间',
...
/*Table structure for table `ci_contact_201804` */

DROP TABLE IF EXISTS `ci_contact_201804`;

CREATE TABLE `ci_contact_201804` (
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_CONTACT_ID` varchar(50) DEFAULT NULL COMMENT '源系统接触流水号',
  `CONTACT_TIME` datetime NOT NULL COMMENT '接触时间',
...
/*Table structure for table `ci_contact_201805` */

DROP TABLE IF EXISTS `ci_contact_201805`;

CREATE TABLE `ci_contact_201805` (
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_CONTACT_ID` varchar(50) DEFAULT NULL COMMENT '源系统接触流水号',
  `CONTACT_TIME` datetime NOT NULL COMMENT '接触时间',
...
/*Table structure for table `ci_contact_201806` */

DROP TABLE IF EXISTS `ci_contact_201806`;

CREATE TABLE `ci_contact_201806` (
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_CONTACT_ID` varchar(50) DEFAULT NULL COMMENT '源系统接触流水号',
  `CONTACT_TIME` datetime NOT NULL COMMENT '接触时间',
...
/*Table structure for table `ci_contact_201807` */

DROP TABLE IF EXISTS `ci_contact_201807`;

CREATE TABLE `ci_contact_201807` (
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_CONTACT_ID` varchar(50) DEFAULT NULL COMMENT '源系统接触流水号',
  `CONTACT_TIME` datetime NOT NULL COMMENT '接触时间',
...
/*Table structure for table `ci_contact_201808` */

DROP TABLE IF EXISTS `ci_contact_201808`;

CREATE TABLE `ci_contact_201808` (
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_CONTACT_ID` varchar(50) DEFAULT NULL COMMENT '源系统接触流水号',
  `CONTACT_TIME` datetime NOT NULL COMMENT '接触时间',
...
/*Table structure for table `ci_contact_201809` */

DROP TABLE IF EXISTS `ci_contact_201809`;

CREATE TABLE `ci_contact_201809` (
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_CONTACT_ID` varchar(50) DEFAULT NULL COMMENT '源系统接触流水号',
  `CONTACT_TIME` datetime NOT NULL COMMENT '接触时间',
...
/*Table structure for table `ci_contact_201810` */

DROP TABLE IF EXISTS `ci_contact_201810`;

CREATE TABLE `ci_contact_201810` (
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_CONTACT_ID` varchar(50) DEFAULT NULL COMMENT '源系统接触流水号',
  `CONTACT_TIME` datetime NOT NULL COMMENT '接触时间',
...
/*Table structure for table `ci_contact_201811` */

DROP TABLE IF EXISTS `ci_contact_201811`;

CREATE TABLE `ci_contact_201811` (
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_CONTACT_ID` varchar(50) DEFAULT NULL COMMENT '源系统接触流水号',
  `CONTACT_TIME` datetime NOT NULL COMMENT '接触时间',
...
/*Table structure for table `ci_contact_201812` */

DROP TABLE IF EXISTS `ci_contact_201812`;

CREATE TABLE `ci_contact_201812` (
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_CONTACT_ID` varchar(50) DEFAULT NULL COMMENT '源系统接触流水号',
  `CONTACT_TIME` datetime NOT NULL COMMENT '接触时间',
...
/*Table structure for table `ci_contact_201901` */

DROP TABLE IF EXISTS `ci_contact_201901`;

CREATE TABLE `ci_contact_201901` (
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_CONTACT_ID` varchar(50) DEFAULT NULL COMMENT '源系统接触流水号',
  `CONTACT_TIME` datetime NOT NULL COMMENT '接触时间',
...
/*Table structure for table `ci_contact_201902` */

DROP TABLE IF EXISTS `ci_contact_201902`;

CREATE TABLE `ci_contact_201902` (
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_CONTACT_ID` varchar(50) DEFAULT NULL COMMENT '源系统接触流水号',
  `CONTACT_TIME` datetime NOT NULL COMMENT '接触时间',
...
/*Table structure for table `ci_contact_201903` */

DROP TABLE IF EXISTS `ci_contact_201903`;

CREATE TABLE `ci_contact_201903` (
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_CONTACT_ID` varchar(50) DEFAULT NULL COMMENT '源系统接触流水号',
  `CONTACT_TIME` datetime NOT NULL COMMENT '接触时间',
...
/*Table structure for table `ci_contact_201904` */

DROP TABLE IF EXISTS `ci_contact_201904`;

CREATE TABLE `ci_contact_201904` (
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_CONTACT_ID` varchar(50) DEFAULT NULL COMMENT '源系统接触流水号',
  `CONTACT_TIME` datetime NOT NULL COMMENT '接触时间',
...
/*Table structure for table `ci_contact_bak` */

DROP TABLE IF EXISTS `ci_contact_bak`;

CREATE TABLE `ci_contact_bak` (
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_CONTACT_ID` varchar(50) DEFAULT NULL COMMENT '源系统接触流水号',
  `CONTACT_TIME` datetime NOT NULL COMMENT '接触时间',
...
/*Table structure for table `ci_interaction_201706` */

DROP TABLE IF EXISTS `ci_interaction_201706`;

CREATE TABLE `ci_interaction_201706` (
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号 ，编码规则：YYYYMMDD+7位序列值',
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_INTERACTION_ID` varchar(50) DEFAULT NULL COMMENT '源系统交互流水号',
  ...
  `ACCOUNT_ID` bigint(15) DEFAULT NULL COMMENT '0.8版本需求,增加对该字段维护,并且增加查询条件',
  PRIMARY KEY (`INTERACTION_ID`),
  KEY `IDX_CI_INTERACTION_201706_01` (`CHANNEL_ID`),
  KEY `IDX_CI_INTERACTION_201706_02` (`INTERACTION_TYPE`),
  KEY `IDX_CI_INTERACTION_201706_03` (`INTERACTION_TIME`),
  KEY `IDX_CI_INTERACTION_201706_04` (`CUST_ID`),
  KEY `IDX_CI_INTERACTION_201706_05` (`OP_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='客户业务交互信息按租户，年月，客户取模分表';

/*Table structure for table `ci_interaction_201803` */

DROP TABLE IF EXISTS `ci_interaction_201803`;

CREATE TABLE `ci_interaction_201803` (
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号 ，编码规则：YYYYMMDD+7位序列值',
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_INTERACTION_ID` varchar(50) DEFAULT NULL COMMENT '源系统交互流水号',
...
/*Table structure for table `ci_interaction_201804` */

DROP TABLE IF EXISTS `ci_interaction_201804`;

CREATE TABLE `ci_interaction_201804` (
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号 ，编码规则：YYYYMMDD+7位序列值',
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_INTERACTION_ID` varchar(50) DEFAULT NULL COMMENT '源系统交互流水号',
...
/*Table structure for table `ci_interaction_201805` */

DROP TABLE IF EXISTS `ci_interaction_201805`;

CREATE TABLE `ci_interaction_201805` (
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号 ，编码规则：YYYYMMDD+7位序列值',
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_INTERACTION_ID` varchar(50) DEFAULT NULL COMMENT '源系统交互流水号',
...
/*Table structure for table `ci_interaction_201806` */

DROP TABLE IF EXISTS `ci_interaction_201806`;

CREATE TABLE `ci_interaction_201806` (
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号 ，编码规则：YYYYMMDD+7位序列值',
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_INTERACTION_ID` varchar(50) DEFAULT NULL COMMENT '源系统交互流水号',
...
/*Table structure for table `ci_interaction_201807` */

DROP TABLE IF EXISTS `ci_interaction_201807`;

CREATE TABLE `ci_interaction_201807` (
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号 ，编码规则：YYYYMMDD+7位序列值',
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_INTERACTION_ID` varchar(50) DEFAULT NULL COMMENT '源系统交互流水号',
...
/*Table structure for table `ci_interaction_201808` */

DROP TABLE IF EXISTS `ci_interaction_201808`;

CREATE TABLE `ci_interaction_201808` (
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号 ，编码规则：YYYYMMDD+7位序列值',
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_INTERACTION_ID` varchar(50) DEFAULT NULL COMMENT '源系统交互流水号',
...
/*Table structure for table `ci_interaction_201809` */

DROP TABLE IF EXISTS `ci_interaction_201809`;

CREATE TABLE `ci_interaction_201809` (
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号 ，编码规则：YYYYMMDD+7位序列值',
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_INTERACTION_ID` varchar(50) DEFAULT NULL COMMENT '源系统交互流水号',
...
/*Table structure for table `ci_interaction_201810` */

DROP TABLE IF EXISTS `ci_interaction_201810`;

CREATE TABLE `ci_interaction_201810` (
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号 ，编码规则：YYYYMMDD+7位序列值',
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_INTERACTION_ID` varchar(50) DEFAULT NULL COMMENT '源系统交互流水号',
...
/*Table structure for table `ci_interaction_201811` */

DROP TABLE IF EXISTS `ci_interaction_201811`;

CREATE TABLE `ci_interaction_201811` (
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号 ，编码规则：YYYYMMDD+7位序列值',
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_INTERACTION_ID` varchar(50) DEFAULT NULL COMMENT '源系统交互流水号',
...
/*Table structure for table `ci_interaction_201812` */

DROP TABLE IF EXISTS `ci_interaction_201812`;

CREATE TABLE `ci_interaction_201812` (
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号 ，编码规则：YYYYMMDD+7位序列值',
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_INTERACTION_ID` varchar(50) DEFAULT NULL COMMENT '源系统交互流水号',
...
/*Table structure for table `ci_interaction_201901` */

DROP TABLE IF EXISTS `ci_interaction_201901`;

CREATE TABLE `ci_interaction_201901` (
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号 ，编码规则：YYYYMMDD+7位序列值',
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_INTERACTION_ID` varchar(50) DEFAULT NULL COMMENT '源系统交互流水号',
...
/*Table structure for table `ci_interaction_201902` */

DROP TABLE IF EXISTS `ci_interaction_201902`;

CREATE TABLE `ci_interaction_201902` (
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号 ，编码规则：YYYYMMDD+7位序列值',
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_INTERACTION_ID` varchar(50) DEFAULT NULL COMMENT '源系统交互流水号',
...
/*Table structure for table `ci_interaction_201903` */

DROP TABLE IF EXISTS `ci_interaction_201903`;

CREATE TABLE `ci_interaction_201903` (
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号 ，编码规则：YYYYMMDD+7位序列值',
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_INTERACTION_ID` varchar(50) DEFAULT NULL COMMENT '源系统交互流水号',
...
/*Table structure for table `ci_interaction_201904` */

DROP TABLE IF EXISTS `ci_interaction_201904`;

CREATE TABLE `ci_interaction_201904` (
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号 ，编码规则：YYYYMMDD+7位序列值',
  `CONTACT_ID` bigint(15) NOT NULL COMMENT '客户接触编号，编码规则：YYYYMMDD+7位序列值',
  `CHANNEL_ID` bigint(8) NOT NULL COMMENT '渠道ID',
  `SRC_INTERACTION_ID` varchar(50) DEFAULT NULL COMMENT '源系统交互流水号',
...
/*Table structure for table `ci_interaction_attr_value_201706` */

DROP TABLE IF EXISTS `ci_interaction_attr_value_201706`;

CREATE TABLE `ci_interaction_attr_value_201706` (
  `INTERACTION_ATTR_VALUE_ID` bigint(15) NOT NULL COMMENT '业务交互项属性值编号',
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号',
  `INTERACTION_ATTR_ID` bigint(12) NOT NULL COMMENT '交互属性编号',
  `INTERACTION_ATTR_CODE` varchar(50) DEFAULT NULL COMMENT '交互属性代码\n            主要冗余外系统传过来的code，这些code在客户交互没有配置',
  ...
  `INTERACTION_TIME` datetime NOT NULL COMMENT '交互时间',
  PRIMARY KEY (`INTERACTION_ATTR_VALUE_ID`),
  KEY `IDX_CI_INTERACTION_ATTR_VALUE_201706_01` (`INTERACTION_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='业务交互属性值按租户，年月，客户取模分表';

/*Table structure for table `ci_interaction_attr_value_201803` */

DROP TABLE IF EXISTS `ci_interaction_attr_value_201803`;

CREATE TABLE `ci_interaction_attr_value_201803` (
  `INTERACTION_ATTR_VALUE_ID` bigint(15) NOT NULL COMMENT '业务交互项属性值编号',
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号',
  `INTERACTION_ATTR_ID` bigint(12) NOT NULL COMMENT '交互属性编号',
  `INTERACTION_ATTR_CODE` varchar(50) DEFAULT NULL COMMENT '交互属性代码\n            主要冗余外系统传过来的code，这些code在客户交互没有配置',
...
/*Table structure for table `ci_interaction_attr_value_201804` */

DROP TABLE IF EXISTS `ci_interaction_attr_value_201804`;

CREATE TABLE `ci_interaction_attr_value_201804` (
  `INTERACTION_ATTR_VALUE_ID` bigint(15) NOT NULL COMMENT '业务交互项属性值编号',
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号',
  `INTERACTION_ATTR_ID` bigint(12) NOT NULL COMMENT '交互属性编号',
  `INTERACTION_ATTR_CODE` varchar(50) DEFAULT NULL COMMENT '交互属性代码\n            主要冗余外系统传过来的code，这些code在客户交互没有配置',
...
/*Table structure for table `ci_interaction_attr_value_201805` */

DROP TABLE IF EXISTS `ci_interaction_attr_value_201805`;

CREATE TABLE `ci_interaction_attr_value_201805` (
  `INTERACTION_ATTR_VALUE_ID` bigint(15) NOT NULL COMMENT '业务交互项属性值编号',
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号',
  `INTERACTION_ATTR_ID` bigint(12) NOT NULL COMMENT '交互属性编号',
  `INTERACTION_ATTR_CODE` varchar(50) DEFAULT NULL COMMENT '交互属性代码\n            主要冗余外系统传过来的code，这些code在客户交互没有配置',
...
/*Table structure for table `ci_interaction_attr_value_201806` */

DROP TABLE IF EXISTS `ci_interaction_attr_value_201806`;

CREATE TABLE `ci_interaction_attr_value_201806` (
  `INTERACTION_ATTR_VALUE_ID` bigint(15) NOT NULL COMMENT '业务交互项属性值编号',
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号',
  `INTERACTION_ATTR_ID` bigint(12) NOT NULL COMMENT '交互属性编号',
  `INTERACTION_ATTR_CODE` varchar(50) DEFAULT NULL COMMENT '交互属性代码\n            主要冗余外系统传过来的code，这些code在客户交互没有配置',
...
/*Table structure for table `ci_interaction_attr_value_201807` */

DROP TABLE IF EXISTS `ci_interaction_attr_value_201807`;

CREATE TABLE `ci_interaction_attr_value_201807` (
  `INTERACTION_ATTR_VALUE_ID` bigint(15) NOT NULL COMMENT '业务交互项属性值编号',
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号',
  `INTERACTION_ATTR_ID` bigint(12) NOT NULL COMMENT '交互属性编号',
  `INTERACTION_ATTR_CODE` varchar(50) DEFAULT NULL COMMENT '交互属性代码\n            主要冗余外系统传过来的code，这些code在客户交互没有配置',
...
/*Table structure for table `ci_interaction_attr_value_201808` */

DROP TABLE IF EXISTS `ci_interaction_attr_value_201808`;

CREATE TABLE `ci_interaction_attr_value_201808` (
  `INTERACTION_ATTR_VALUE_ID` bigint(15) NOT NULL COMMENT '业务交互项属性值编号',
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号',
  `INTERACTION_ATTR_ID` bigint(12) NOT NULL COMMENT '交互属性编号',
  `INTERACTION_ATTR_CODE` varchar(50) DEFAULT NULL COMMENT '交互属性代码\n            主要冗余外系统传过来的code，这些code在客户交互没有配置',
...
/*Table structure for table `ci_interaction_attr_value_201809` */

DROP TABLE IF EXISTS `ci_interaction_attr_value_201809`;

CREATE TABLE `ci_interaction_attr_value_201809` (
  `INTERACTION_ATTR_VALUE_ID` bigint(15) NOT NULL COMMENT '业务交互项属性值编号',
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号',
  `INTERACTION_ATTR_ID` bigint(12) NOT NULL COMMENT '交互属性编号',
  `INTERACTION_ATTR_CODE` varchar(50) DEFAULT NULL COMMENT '交互属性代码\n            主要冗余外系统传过来的code，这些code在客户交互没有配置',
...
/*Table structure for table `ci_interaction_attr_value_201810` */

DROP TABLE IF EXISTS `ci_interaction_attr_value_201810`;

CREATE TABLE `ci_interaction_attr_value_201810` (
  `INTERACTION_ATTR_VALUE_ID` bigint(15) NOT NULL COMMENT '业务交互项属性值编号',
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号',
  `INTERACTION_ATTR_ID` bigint(12) NOT NULL COMMENT '交互属性编号',
  `INTERACTION_ATTR_CODE` varchar(50) DEFAULT NULL COMMENT '交互属性代码\n            主要冗余外系统传过来的code，这些code在客户交互没有配置',
...
/*Table structure for table `ci_interaction_attr_value_201811` */

DROP TABLE IF EXISTS `ci_interaction_attr_value_201811`;

CREATE TABLE `ci_interaction_attr_value_201811` (
  `INTERACTION_ATTR_VALUE_ID` bigint(15) NOT NULL COMMENT '业务交互项属性值编号',
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号',
  `INTERACTION_ATTR_ID` bigint(12) NOT NULL COMMENT '交互属性编号',
  `INTERACTION_ATTR_CODE` varchar(50) DEFAULT NULL COMMENT '交互属性代码\n            主要冗余外系统传过来的code，这些code在客户交互没有配置',
...
/*Table structure for table `ci_interaction_attr_value_201812` */

DROP TABLE IF EXISTS `ci_interaction_attr_value_201812`;

CREATE TABLE `ci_interaction_attr_value_201812` (
  `INTERACTION_ATTR_VALUE_ID` bigint(15) NOT NULL COMMENT '业务交互项属性值编号',
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号',
  `INTERACTION_ATTR_ID` bigint(12) NOT NULL COMMENT '交互属性编号',
  `INTERACTION_ATTR_CODE` varchar(50) DEFAULT NULL COMMENT '交互属性代码\n            主要冗余外系统传过来的code，这些code在客户交互没有配置',
...
/*Table structure for table `ci_interaction_attr_value_201901` */

DROP TABLE IF EXISTS `ci_interaction_attr_value_201901`;

CREATE TABLE `ci_interaction_attr_value_201901` (
  `INTERACTION_ATTR_VALUE_ID` bigint(15) NOT NULL COMMENT '业务交互项属性值编号',
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号',
  `INTERACTION_ATTR_ID` bigint(12) NOT NULL COMMENT '交互属性编号',
  `INTERACTION_ATTR_CODE` varchar(50) DEFAULT NULL COMMENT '交互属性代码\n            主要冗余外系统传过来的code，这些code在客户交互没有配置',
...
/*Table structure for table `ci_interaction_attr_value_201902` */

DROP TABLE IF EXISTS `ci_interaction_attr_value_201902`;

CREATE TABLE `ci_interaction_attr_value_201902` (
  `INTERACTION_ATTR_VALUE_ID` bigint(15) NOT NULL COMMENT '业务交互项属性值编号',
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号',
  `INTERACTION_ATTR_ID` bigint(12) NOT NULL COMMENT '交互属性编号',
  `INTERACTION_ATTR_CODE` varchar(50) DEFAULT NULL COMMENT '交互属性代码\n            主要冗余外系统传过来的code，这些code在客户交互没有配置',
...
/*Table structure for table `ci_interaction_attr_value_201903` */

DROP TABLE IF EXISTS `ci_interaction_attr_value_201903`;

CREATE TABLE `ci_interaction_attr_value_201903` (
  `INTERACTION_ATTR_VALUE_ID` bigint(15) NOT NULL COMMENT '业务交互项属性值编号',
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号',
  `INTERACTION_ATTR_ID` bigint(12) NOT NULL COMMENT '交互属性编号',
  `INTERACTION_ATTR_CODE` varchar(50) DEFAULT NULL COMMENT '交互属性代码\n            主要冗余外系统传过来的code，这些code在客户交互没有配置',
...
/*Table structure for table `ci_interaction_attr_value_201904` */

DROP TABLE IF EXISTS `ci_interaction_attr_value_201904`;

CREATE TABLE `ci_interaction_attr_value_201904` (
  `INTERACTION_ATTR_VALUE_ID` bigint(15) NOT NULL COMMENT '业务交互项属性值编号',
  `INTERACTION_ID` bigint(15) NOT NULL COMMENT '业务交互编号',
  `INTERACTION_ATTR_ID` bigint(12) NOT NULL COMMENT '交互属性编号',
  `INTERACTION_ATTR_CODE` varchar(50) DEFAULT NULL COMMENT '交互属性代码\n            主要冗余外系统传过来的code，这些code在客户交互没有配置',
