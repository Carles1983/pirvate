...
import com.aii.crm.agr.web.constant.AgrWebConstant;
import com.aii.crm.agr.web.persistence.bo.AgrAgreement;
import com.aii.crm.agr.web.persistence.bo.AgrAgreementExample;
import com.aii.crm.agr.web.persistence.mapper.AgrAgreementMapper;
import com.aii.crm.agr.web.service.interfaces.IAgreementSV;
...
public class AgreementSVImpl implements IAgreementSV {
	...
	public Integer updateAgreementStatusByCustomerIdAndOrderId(Long customerId, Long customerOrderId, Long agreementStatus) {
		List<AgrAgreement> agreementList = queryAgreementByCustIdAndCustOrderId(customerId,
				customerOrderId, AgrWebConstant.AGR_STATE_VALID);
